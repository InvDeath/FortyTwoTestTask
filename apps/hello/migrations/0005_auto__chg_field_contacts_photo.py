...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contacts.photo'
        db.alter_column(u'hello_contacts', 'photo', self.gf('django_resized.forms.ResizedImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Contacts.photo'
        db.alter_column(u'hello_contacts', 'photo', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
